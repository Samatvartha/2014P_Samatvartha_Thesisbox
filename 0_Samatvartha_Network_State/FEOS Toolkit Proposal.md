...
An Architectural Blueprint for India's Self-Enterprising Economy
...
| :--- | :--- | :--- | :--- | :--- |
| **S1: Soloist** | Unregistered Proprietor (using a dedicated business bank account) | The default for solo professionals and for zero-friction idea validation. A valid steady-state for many. | **Avoids:** All formal compliance & capital friction. | • Personal Income Tax |
